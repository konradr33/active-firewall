...
class TestDosDetectorMethods(unittest.TestCase):
    def setUp(self):
        ...
        self.dos_detector = DosDetector(self.iptables_adapter, self.allowed_packets_per_interval,
                                        self.large_packet_size, self.allowed_large_packets_per_interval,
    ...
    def test_add_rule_with_timeout_normal_packets(self):
        self.iptables_adapter.add_rule_with_timeout = MagicMock()
